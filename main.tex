...
\section{Personal}
	\cvitem{\hskip -0.5cm On my free time}{
		...
		trying to apply as many techniques I know as possible going from optimizing the algorithm/data
	...
	\cvitem{Travel}{
		I love to travel, so far I visited the following country:
		\begin{itemize}
		...
		in one day but I usually stay below the 100Km per day.
	}
	\cvitem{Other}{
