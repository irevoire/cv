...
\section{Work Experience}
	\cventry{
		\hspace*{-0.5cm}
		Mar--Aug 2020\\
		\includegraphics[width=1cm]{huawei}
			...
			lalalalaalalaTOTO lalalalaalalaTOTO lalalalaalalaTOTO lalalalaalalaTOTO
			lalalalaalalaTOTO lalalalaalalaTOTO lalalalaalalaTOTO lalalalaalalaTOTO
			lalalalaalalaTOTO lalalalaalalaTOTO lalalalaalalaTOTO lalalalaalalaTOTO
			lalalalaalalaTOTO lalalalaalalaTOTO lalalalaalalaTOTO lalalalaalalaTOTO
			lalalalaalalaTOTO lalalalaalalaTOTO lalalalaalalaTOTO lalalalaalalaTOTO
	...
	\cventry{
		\hspace*{-0.5cm}
		Apr--Aug 2017\\
		\includegraphics[width=1.5cm]{stormshield}
		}{Optimizing the access of the Firewall rules}{\href{https://www.stormshield.com/}{StormShield}}{Lille}{}{
...
\section{Languages}
	...
	\cvitemwithcomment{\textbf{Rust}}{< 100 000 LoC}{ 
		...
		On my personnal project I also developped the \href{https://github.com/irevoire/mandelbrust}{mandelbrot} and \href{https://github.com/irevoire/rulia}{julia’s} set using parallelization and SIMD.
		I developed a \href{https://github.com/irevoire/chrustip-8}{chip-8}, \href{https://github.com/irevoire/esolangs}{brainfuck, Argh! interpreters} and a \href{https://github.com/irevoire/game_of_life}{conway’s game of life}.
		I also often participate in some problem solving challenge like \href{https://github.com/irevoire/project_euler}{project euler} and \href{https://github.com/irevoire/aoc}{advent of code}
...
\section{Technologies}
	\cvitem{Software}{
			 \begin{itemize}
				 ...
				 \item FreeBSD (2 year): The Firewall during my internship at StormShield were running on FreeBSD.
