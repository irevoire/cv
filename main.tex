...
\section{Education}
	\cventry{
		...
		\vspace*{0.2cm}
		\hspace*{-0.5cm}
		\href{https://univ-lille.fr/}{\includegraphics[width=0.7cm]{univ}}
...
\section{Work Experience}
	\cventry{
		...
		Mar 2021 -- Now\\
		\vspace*{0.2cm}
		\href{https://www.meilisearch.com/}{\includegraphics[width=1.5cm]{meilisearch}}
			...
			search engine written in rust. I've been hired to help the core team with all the
			day-to-day tasks. I work as much on \mhref{https://github.com/meilisearch/meilisearch}{meilisearch}
			as on \mhref{https://github.com/meilisearch/milli}{milli} (the core library of meilisearch).
			I help keeping the codebase healthy by updating the dependencies, refactoring the code,
			adding a formatter to the project and enforcing it with the CI, answering issues etc.
			And obviously, most of my time is spent implementing new features. Like the
			\mhref{https://docs.meilisearch.com/reference/api/stop_words.html}{stop-words}, the
			\mhref{geosearch}{https://github.com/meilisearch/specifications/pull/59}.
			I also work on the specifications of new features.
			For some complex subjects like high availability, replication or shardings, I also read and
	...
	\cventry{
		...
		\vspace*{0.4cm}
		\hspace*{-0.4cm}
		\href{https://worldline.com/}{\includegraphics[width=2.4cm]{worldline}}
...
\section{Technologies}
	...
	\cvitemwithcomment{Haskell, ASM, Go, HDL, lua}{< 2000 LoC}{I enjoy these languages but do not work with a lot.}
